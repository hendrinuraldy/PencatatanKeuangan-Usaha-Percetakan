...
<link rel="shortcut icon" href="img/icon.png">
  ...
  <title>Login | CatatanKeuangan</title>
  <link rel="shortcut icon" href="img/icon.png">
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Registrasi untuk gunakan CatatanKeuangan</div>
              </div>
              ...
              <div class="card-body">
                <form method="POST">
                  ...
                  <button type="submit" name="sign-up" class="btn btn-primary">Daftar</button>
                </form>
              </div>
            </div>
            <div class="img"></div>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Login untuk gunakan CatatanKeuangan</div>
              </div>
              <div class="icon-user">
                <h4 class="fa fa-user"></h4>
              </div>
