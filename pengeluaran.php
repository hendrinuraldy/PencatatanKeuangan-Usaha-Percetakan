...
<head>
    ...
    <title>CatatanKeuangan - Pengeluaran</title>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id="keperluanTambah" class="form-control">
                                <option>Biaya Bahan Baku</option>
                                <option>Biaya Operasional</option>
                                <option>Biaya Tenaga Kerja</option>
                                <option>Biaya Penyusutan Aset</option>
                                <option>Biaya Tidak Terduga</option>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    const tombolTambah = document.querySelector('.tambahKeluar');

    tombolTambah.addEventListener('click', function(event) {
      event.preventDefault(); // Biar gak submit form langsung (kalau perlu)
