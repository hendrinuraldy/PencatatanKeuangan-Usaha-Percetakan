...
<script type="text/javascript">
    ...
    var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ["Biaya Bahan Baku", "Biaya Operasional", "Biaya Tenaga Kerja", "Biaya Penyusutan Aset", "Biaya Tidak Terduga", "Keperluan pribadi"],
            datasets: [{
                label: 'Data Pengeluaran',
                data: [
                <?php 
                $makan = mysqli_query($koneksi,"SELECT * FROM pengeluaran WHERE username = '$username' AND keperluan='Biaya Bahan Baku' AND tanggal BETWEEN '$tanggalAwal' AND '$tanggalAkhir'");
                echo mysqli_num_rows($makan);
                ?>, 
                <?php 
                $hutang = mysqli_query($koneksi,"SELECT * FROM pengeluaran WHERE username = '$username' AND keperluan='Biaya Operasional' AND tanggal BETWEEN '$tanggalAwal' AND '$tanggalAkhir'");
                echo mysqli_num_rows($hutang);
                ?>, 
                <?php 
                $peralatan = mysqli_query($koneksi,"SELECT * FROM pengeluaran WHERE username = '$username' AND keperluan='Biaya Tenaga Kerja' AND tanggal BETWEEN '$tanggalAwal' AND '$tanggalAkhir'");
                echo mysqli_num_rows($peralatan);
                ?>, 
                <?php 
                $organisasi = mysqli_query($koneksi,"SELECT * FROM pengeluaran WHERE username = '$username' AND keperluan='Biaya Penyusutan Aset' AND tanggal BETWEEN '$tanggalAwal' AND '$tanggalAkhir'");
                echo mysqli_num_rows($organisasi);
                ?>, 
                <?php 
                $kendaraan = mysqli_query($koneksi,"SELECT * FROM pengeluaran WHERE username = '$username' AND keperluan='Biaya Tidak Terduga' AND tanggal BETWEEN '$tanggalAwal' AND '$tanggalAkhir'");
