...
/* Tambahkan ini untuk isi logout */
.logout {
    display: flex;
    align-items: center;
    gap: 5px;
...
<head>
    ...
    <title>CatatanKeuangan - Laporan</title>
...
<div class="header">
    <div class="left-section">
        <img src="img/icon.png" width="25" height="25" class="logo-fav">
        <h3 class="text-secondary font-weight-bold logo">CatatanKeuangan</h3>
    </div>
